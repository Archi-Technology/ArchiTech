...
export function ResourceTabs({ pricingOption, setPricingOption, resources, spotInstances, savingsPlans, selectedResource, setSelectedResource, isVirtualMachine, }) {
