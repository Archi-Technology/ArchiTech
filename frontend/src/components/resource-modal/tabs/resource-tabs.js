...
const on_demand_tab_1 = require("./on-demand-tab");
const spot_instances_tab_1 = require("./spot-instances-tab");
const savings_plans_tab_1 = require("./savings-plans-tab");
function ResourceTabs({ serviceName, pricingOption, setPricingOption, resources, spotInstances, savingsPlans, selectedResource, setSelectedResource, isVirtualMachine, }) {
